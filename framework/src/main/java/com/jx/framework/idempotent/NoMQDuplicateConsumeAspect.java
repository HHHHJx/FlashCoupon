package com.jx.framework.idempotent;

import com.jx.framework.exception.ServiceException;
...
public final class NoMQDuplicateConsumeAspect {
     ...
     */
    @Around("@annotation(com.jx.framework.idempotent.NoMQDuplicateConsume)")
